...
import falcofinder.android.fuehrerschein.chat.client.MyRequestFactory;
import falcofinder.android.fuehrerschein.chat.client.MyRequestFactory.HelloWorldRequest;
import falcofinder.android.fuehrerschein.chat.client.MyRequestFactory.MessageRequest;
import falcofinder.android.fuehrerschein.chat.shared.MessageProxy;

public class FuehrerscheinChatWidget extends Composite {
  ...
  interface FuehrerscheinChatUiBinder extends UiBinder<Widget, FuehrerscheinChatWidget> {
  }

  private static FuehrerscheinChatUiBinder uiBinder = GWT.create(FuehrerscheinChatUiBinder.class);
  ...
  public FuehrerscheinChatWidget() {
